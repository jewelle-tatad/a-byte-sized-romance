;メッセージレイヤの定義
		...
		[position width=1494 height=295 top=720 left=213 ]


		
			[position page=fore frame="mym_ui.png" margint=75 marginl=50 marginr=50 marginb=50 vertical=false opacity="250" ]
		

		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=26 x=278 y=740 bold="bold" edge="undefined" shadow="undefined"]
		...
		[position layer="message1" width=1494 height=295 top=720 left=213 ]
		[position layer="message1" page=fore margint=5 marginl=10 marginr=10 marginb=10 vertical=false opacity="250" radius="0" color="0x000000" ]
